...
export default function App() {
  ...
  const getDynamicText = (shop, fieldName) => {
    if (language === 'en' && shop[`${fieldName}_en`]) return shop[`${fieldName}_en`];
